...
export function renderBlueprintDetail(
  root,
  ...
  root.onclick = (event) => {
    ...
    if (isBlueprintDetailAction(action)) onAction?.(action, blueprint);
  };
}
