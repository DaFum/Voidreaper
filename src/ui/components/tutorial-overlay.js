...
export function createTutorialOverlay({ root, resolveTarget, onAction = () => {} }) {
  ...
  const refresh = () => {
    ...
    if (!ring || !card) return;
    const statusText = target || !targetId ? "" : "Ziel ist nicht sichtbar. Öffne den zugehörigen Bereich.";
