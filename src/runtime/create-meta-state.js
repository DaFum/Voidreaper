import { createTutorialState } from "../persistence/migrations/tutorial-migration.js";
...
export function createMetaState() {
  return {
    ...
    campaignPaths: { architect: { unlocked: true, completions: 0 } }, buildHistory: {}, tutorial: createTutorialState()
  };
}
