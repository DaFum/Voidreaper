...
const profile = (id, grid, motifs, density, motion = "drift") =>
  Object.freeze({
    id,
    palette: REGION_VISUAL_PALETTES[id],
    grid,
...
const REGION_VISUAL_PROFILES = Object.freeze({
  "shattered-approach": profile(
    "shattered-approach",
    "fracture",
    ["shard", "broken-rail"],
    0.42,
  ),
  "furnace-expanse": profile(
    "furnace-expanse",
    "plates",
    ["vent", "slag-crack"],
    0.58,
...
export const REGION_VISUAL_PROFILE_IDS = Object.freeze(
  Object.keys(REGION_VISUAL_PROFILES),
);
