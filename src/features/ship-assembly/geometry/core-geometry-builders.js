...
registerCoreGeometry("core-vesper-spear", () => core({
  structurePaths:[line({x:0,y:-30}, {x:0,y:20}, 1.5)], detailPaths:[line({x:-10,y:0},{x:10,y:0}, 1)],
...
registerCoreGeometry("core-bastion-citadel", () => core({
  structurePaths:[line({x:-20,y:0},{x:20,y:0}, 1.5)], detailPaths:[line({x:-10,y:-10},{x:10,y:-10}, 1)],
...
registerCoreGeometry("core-specter-phase", () => core({
  structurePaths:[line({x:0,y:-20},{x:0,y:20}, 1.5)], detailPaths:[line({x:-15,y:5},{x:15,y:5}, 1)], voidPaths:[lens(0, 5, 8, 12)],
...
registerCoreGeometry("core-furnace-kiln", () => core({
  structurePaths:[line({x:-15,y:-15},{x:15,y:-15}, 1.5)], detailPaths:[line({x:-20,y:10},{x:20,y:10}, 1)],
...
registerCoreGeometry("core-reliquary-casket", () => core({
  structurePaths:[line({x:0,y:-20},{x:0,y:20}, 1.5)], detailPaths:[line({x:-15,y:0},{x:15,y:0}, 1)], voidPaths:[lens(0, 0, 10, 15)],
...
registerCoreGeometry("core-shepherd-carrier", () => core({
  structurePaths:[line({x:-30,y:0},{x:30,y:0}, 1.5)], detailPaths:[line({x:-20,y:-10},{x:20,y:-10}, 1)],
...
registerCoreGeometry("core-harrow-scythe", () => core({
  structurePaths:[line({x:0,y:-20},{x:0,y:10}, 1.5)], detailPaths:[line({x:-10,y:5},{x:10,y:5}, 1)],
...
registerCoreGeometry("core-gravewright-rig", () => core({
  structurePaths:[line({x:-20,y:-10},{x:20,y:10}, 1.5)], detailPaths:[line({x:-10,y:0},{x:10,y:0}, 1)],
...
registerCoreGeometry("core-null-choir-fracture", () => core({
  structurePaths:[line({x:-15,y:-15},{x:15,y:15}, 1.5)], detailPaths:[line({x:-10,y:0},{x:10,y:0}, 1)], voidPaths:[lens(0, 0, 12, 18)],
