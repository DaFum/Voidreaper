export function createAssemblyDebugService(deps) {
  return {
    ...
    addBridge: (sourceNodeId, targetNodeId) =>
      deps.assembly().addSecondaryConnection({
        sourceNodeId,
        targetNodeId,
