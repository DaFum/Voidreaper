...
const byTier = (tier) =>
  FAULTS.filter((entry) => entry.tier === tier).map((entry) => entry.id);
...
export const FAULT_PROFILES = Object.freeze([
  ...
  },
  {
    ...
    name: "Projectile Feed",
    light: ["target-drift", "scatter-spike"],
    medium: ["early-detonation"],
    heavy: ["projectile-reflection"],
  },
  {
    id: "weapon-drone",
    name: "Drone Link",
    light: ["drone-pause"],
    medium: ["shield-inversion"],
    heavy: ["hostile-drone"],
  },
  {
    id: "weapon-beam",
