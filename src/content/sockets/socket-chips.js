const chip = (id, name, tags, behavior) => ({
  id,
  name,
  slot: "socket",
  tags,
...
export const SOCKET_CHIPS = Object.freeze([
  ...
  chip(
    ...
    "reduce-corruption-block-forbidden",
  ),
  chip(
    "blood-circuit",
    "Blood Circuit",
    ["Healing", "Charge"],
    "healing-charges-active",
  ),
  chip(
    "rail-splinter",
    "Rail Splinter",
  ...
  chip(
    ...
    "Workshop Key",
    ["Crafting"],
    "free-first-socket-action",
  ),
  chip(
    "abyss-signal",
    "Abyss Signal",
    ["Void", "Corruption"],
    "abyss-depth-scales-chip",
  ),
]);
