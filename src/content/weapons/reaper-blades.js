...
export default createWeaponDefinition({
  overrideVisualProfileId: "orbit-hub", id: "reaper-blades", name: "REAPER BLADES", energyCost: 28, heat: 2, tags: [{ id: "Weapon", value: 1 }, { id: "Orbit", value: 3 }, { id: "Kinetic", value: 2 }, { id: "Bleed", value: 2 }, { id: "Critical", value: 1 }], effects: [{ id: "deal-damage" }], faultProfileId: "weapon-projectile", unlockSource: "blueprint" }, adapter);
