...
export default createWeaponDefinition({ id: "nanite-swarm", name: "NANITE SWARM", energyCost: 38, heat: 3, tags: [{ id: "Weapon", value: 1 }, { id: "Summon", value: 2 }, { id: "Corrosion", value: 3 }, { id: "Chain", value: 1 }, { id: "Sacrifice", value: 1 }], effects: ["apply-status", "summon-unit"], faultProfileId: "weapon-drone", unlockSource: "blueprint" }, adapter);
