...
export default createWeaponDefinition({
  overrideVisualProfileId: "void-anomaly", id: "anomaly-engine", name: "ANOMALY ENGINE", energyCost: 40, heat: 5, corruption: 6, tags: [{ id: "Weapon", value: 1 }, { id: "Anomaly", value: 3 }, { id: "Echo", value: 2 }, { id: "Corruption", value: 2 }], effects: [{ id: "deal-damage" }, { id: "teleport" }, { id: "spawn-zone" }], faultProfileId: "standard", unlockSource: "blueprint" }, adapter);
