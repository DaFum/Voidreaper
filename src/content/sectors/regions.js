const REGIONS = Object.freeze([
  ...
  { id: "null-cathedral", name: "Null Cathedral", palette: ["#26062f", "#050108"], floor: "distorted", enemies: ["warper", "leech"], loot: "corrupted", audio: "choir", rule: "corruption" },
  { id: "architects-crown", name: "Architect's Crown", palette: ["#0c1d2d", "#02030a"], floor: "segments", enemies: ["shield", "boss"], loot: "prototype", audio: "architect", rule: "rotating" }
]);
