...
export const ANOMALY_EVENTS = Object.freeze([
  ...
  event("cold-forge", "Cold Forge", "Eine Werkstatt arbeitet ohne Besatzung.", [choice("temper", "Prototyp härten", "+8 Hitze", "+10 Item Power", "Affix kann brechen", run => { run.services.heat.add(run.heat, 8, "anomaly-cold-forge"); }), choice("drain", "Kühlmittel bergen", "Keine", "+25 Scrap", "Forge erlischt", run => { run.resources.scrap += 25; })]),
