...
export const ANOMALY_EVENTS = Object.freeze([
  ...
  event("dead-pilot", "Dead Pilot", "Der Flugschreiber sendet noch.", [
    choice(
      ...
      "+5 Korruption",
      "Karte aufdecken",
      "Unbekannter Verfolger",
      (run) => {
        changeRunCorruption(run, 5, "anomaly-dead-pilot");
      },
    ),
    choice("salute", "Weiterziehen", "Keine", "+5 Hull", "Keine", (run) => {
    ...
    event(
      ...
      [
        choice(
          ...
          `+${5 + index} Korruption`,
          `+${15 + index * 2} Scrap`,
          "Eine spätere Begegnung verändert sich",
          (run) => {
