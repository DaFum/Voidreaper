...
const optionalAct = (id, title, body, target, event, matches, hint) => ({
  ...act(id, title, body, target, event, matches, hint),
  optional: true,
});
...
const foundations = [
  ...
  act(
    "move",
    "BEWEGUNG",
    "Bewege das Schiff. Positionierung hält dich am Leben.",
    "game-canvas",
    E.MOVEMENT_USED,
    (p) => p?.magnitude > 0.25,
    "WASD oder Touch-Stick",
  ),
  explain(
    "fire",
    "AUTOMATISCHES FEUER",
  ...
  act(
    "dodge",
    "AUSWEICHEN",
    "Weiche durch eine Gefahrenzone aus.",
    "hud-dodge",
    E.DODGE_USED,
  ),
  explain(
  ...
  act(
    "pause",
    "PAUSE",
    "Öffne die Pause. Dort kannst du den Run sicher unterbrechen.",
    "hud-pause",
    E.PAUSE_OPENED,
  ),
  act(
    "resume",
    "WEITERFLIEGEN",
    "Setze den Trainingslauf fort, bevor du wieder in den Kampf eingreifst.",
    "pause-resume",
    E.RUN_RESUMED,
  ),
  act(
    "enemy",
    "GEGNER",
    "Besiege ein Ziel; Belohnungen erscheinen erst nach dem bestätigten Abschuss.",
    "game-canvas",
    E.ENEMY_DEFEATED,
  ),
  act(
  ...
  act(
    "evolution",
    "EVOLUTION",
    "Wähle eine Verbesserung. Sie verändert den laufenden Build.",
    "levelup-options",
    E.EVOLUTION_SELECTED,
  ),
  explain(
    "complete",
    "SIGNAL VERSTANDEN",
...
const navigation = [
  ...
  act(
    "select",
    "SIGNAL WÄHLEN",
    "Wähle einen erreichbaren Knoten einmal zur Prüfung.",
    "sector-map",
    E.SECTOR_SELECTED,
  ),
  act(
    "enter",
    "ROUTE BESTÄTIGEN",
    "Bestätige denselben Knoten erneut.",
    "sector-detail",
    E.SECTOR_ENTERED,
  ),
  explain(
  ...
  optionalAct(
    "buy",
    "KAUF ABSCHLIESSEN",
    "Kaufe ein bezahlbares Angebot. Ohne erreichbaren Händler kannst du den Schritt fortsetzen.",
    "merchant-offers",
    E.MERCHANT_PURCHASED,
    (p) => p?.success,
  ),
  explain(
    "workshop",
  ...
  optionalAct(
    "forge",
    "AKTION ANWENDEN",
    "Bestätige eine verfügbare Werkstattaktion oder setze ohne erreichbare Werkstatt fort.",
    "workshop-actions",
    E.WORKSHOP_APPLIED,
    (p) => p?.success,
  ),
  optionalAct(
    "checkpoint",
    "CHECKPOINT",
    "Setze einen gespeicherten Run fort oder fahre ohne vorhandenen Checkpoint fort.",
    "checkpoint-resume",
    E.CHECKPOINT_RESUMED,
  ),
  optionalAct(
    "anomaly",
    "ANOMALIE",
    "Wähle einen Tausch oder setze ohne erreichbaren Anomalieknoten fort.",
    "anomaly-choices",
    E.ANOMALY_RESOLVED,
  ),
];
const assembly = [
  ...
  optionalAct(
    "quick-action",
    "MONTAGE",
    "Montiere oder lagere den Vorschlag; ohne neue Beute kannst du fortsetzen.",
    "quick-mount-actions",
    E.QUICK_MOUNT_ACTION,
    (p) => p?.success !== false,
  ),
  explain(
    "workbench",
  ...
  optionalAct(
    "workbench-action",
    "KONSTRUKTION ÄNDERN",
    "Führe eine Werkbankaktion aus oder setze ohne Run-Inventar fort.",
    "workbench-actions",
    E.WORKBENCH_ACTION,
    (p) => p?.success,
  ),
  ...
  optionalAct(
    "blueprint-action",
    "BAUPLAN VERWENDEN",
    "Verwende eine Bauplanaktion oder setze ohne gespeicherten Bauplan fort.",
    "blueprint-actions",
    E.BLUEPRINT_ACTION,
    (p) => p?.success,
  ),
...
const meta = [
  ...
  act(
    "research-buy",
    "FORSCHEN",
    "Kaufe einen verfügbaren Forschungsknoten.",
    "research-grid",
    E.RESEARCH_PURCHASED,
  ),
  explain(
    "prototypes",
    "PROTOTYPEN",
  ...
  act(
    "simulator",
    "SIMULATOR",
    "Starte eine reproduzierbare Simulation und lies DPS, Trigger und Fehler.",
    "simulator-start",
    E.SIMULATION_COMPLETED,
  ),
  explain(
    "statistics",
    "STATISTIKEN",
...
const advanced = [
  ...
  optionalAct(
    "extract",
    "EXTRAKTION",
    "Schließe eine Extraktion ab oder setze fort, wenn kein Extraktionsfenster verfügbar ist.",
    "extraction-options",
    E.EXTRACTION_COMPLETED,
  ),
  optionalAct(
    "summary",
    "ZUSAMMENFASSUNG",
    "Prüfe die Run-Zusammenfassung oder setze ohne beendeten Run fort.",
    "run-summary",
    E.RUN_SUMMARY_OPENED,
  ),
];
const controls = [
  explain(
  ...
  act(
    "setting",
    "ANZEIGE ANPASSEN",
    "Ändere UI-Skalierung oder eine Anzeigeoption.",
    "settings-controls",
    E.SETTING_CHANGED,
  ),
  explain(
