...
import { REACTOR_EFFECT_IDS, SHIP_EFFECT_IDS } from "../src/content/effects/latent-effect-manifest.js";
...
const effects = new Set([...Object.keys(CORE_EFFECT_HANDLERS), "evolution-prism-lance", "evolution-singularity", "evolution-blood-halo", "evolution-reaper-protocol", "evolution-ion-tempest", ...SHIP_EFFECT_IDS, ...REACTOR_EFFECT_IDS, ...MODULE_EFFECT_IDS]);
