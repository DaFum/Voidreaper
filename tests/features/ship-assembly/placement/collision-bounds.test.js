...
describe("collision-bounds", () => {
  describe("overlapsAny", () => {
    ...
    it("should return true if fully overlapping and different owner", () => {
      const candidate = { ownerId: "c1", minX: 0, minY: 0, maxX: 10, maxY: 10 };
      const occupied = [{ ownerId: "o1", minX: 2, minY: 2, maxX: 8, maxY: 8 }];
    ...
    it("should use default margin of 4", () => {
      ...
      assert.equal(
        overlapsAny(candidate, [
          { ownerId: "o1", minX: 14, minY: 0, maxX: 20, maxY: 10 },
        ]),
        true,
      );
      ...
      assert.equal(
        overlapsAny(candidate, [
          { ownerId: "o1", minX: -10, minY: 0, maxX: -5, maxY: 10 },
        ]),
        false,
      );
      ...
      assert.equal(
        overlapsAny(candidate, [
          { ownerId: "o1", minX: -10, minY: 0, maxX: -4, maxY: 10 },
        ]),
        true,
      );
      ...
      assert.equal(
        overlapsAny(candidate, [
          { ownerId: "o1", minX: 0, minY: 15, maxX: 10, maxY: 20 },
        ]),
        false,
      );
      ...
      assert.equal(
        overlapsAny(candidate, [
          { ownerId: "o1", minX: 0, minY: 14, maxX: 10, maxY: 20 },
        ]),
        true,
      );
      ...
      assert.equal(
        overlapsAny(candidate, [
          { ownerId: "o1", minX: 0, minY: -10, maxX: 10, maxY: -5 },
        ]),
        false,
      );
      ...
      assert.equal(
        overlapsAny(candidate, [
          { ownerId: "o1", minX: 0, minY: -10, maxX: 10, maxY: -4 },
        ]),
        true,
      );
    });
